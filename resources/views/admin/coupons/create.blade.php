                        ...
                        <div class="flex-auto">
                            ...
                            <div class="mt-4">
                                <label class="block">
                                    ...
                                    <input type="date" name="validity" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" value="{{ old('validity') }}"
                            ...
                            <div>
                                ...
                                <span class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-semibold text-slate-700 mb-3">Cidades</span>
                                    ...
                                    <label class="flex items-center mb-1">
                                        <input type="checkbox" name="city[]" class="appearance-none checked:bg-violet-900" value="{{ $city->id }}" />
